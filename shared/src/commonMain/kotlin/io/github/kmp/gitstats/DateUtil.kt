...
class DateUtil {
    companion object {
        ...
        fun currentMilliseconds(): Long = kotlin.time.Clock.System.now().toEpochMilliseconds()
        ...
        @JvmStatic
        fun kotlinx.datetime.LocalDate.formatToString(pattern: String = "yyyy-MM-dd"): String {
        ...
        @JvmStatic
        fun kotlinx.datetime.LocalDate.formatToMDString(): String {
            return formatToString("MM-dd")
        }

        @JvmStatic
        fun kotlinx.datetime.LocalDate.formatToYString(): String {
